...
#Arbitrary order chosen for Tu-22 by me (EnRogue) to try & maintain CG in range

var fuel_node = props.globals.getNode("/consumables/fuel");

var engFeedN = 2; #number of tank which serves as engine feed

var interval = 0.1; #approximate transfer cycle interval
var galsPerSec = 7.5; #fuel flow to engine feed tank (gal_us/sec)
...
var tanks = [
	...
	fuelTank.new(1, 1),
	fuelTank.new(3, 1),
	#forward fuselage & aft rear fuselage tanks
        fuelTank.new(0, 2),
	fuelTank.new(4, 2),
        fuelTank.new(5, 2),
	#wing tanks
...
print(" Tu-22 fuel system initialized");
